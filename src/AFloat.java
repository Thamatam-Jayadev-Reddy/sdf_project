...
public class AFloat{
    ...
    public AFloat(AFloat other_int){
    ...
    public static void main(String[] args){
        AFloat num1 = new AFloat("3.930400");
        AFloat num2 = new AFloat("15.02934");

        AFloat res = num2.divide(num1);
        System.out.println(res.float_string);
    }
}